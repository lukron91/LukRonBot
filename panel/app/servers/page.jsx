...
import { FiLogOut, FiPlusCircle, FiSettings, FiShield, FiUser, FiCheckCircle, FiXCircle } from 'react-icons/fi';
  ...
  useEffect(() => {
    const init = async () => {
      ...
      try {
        ...
        // Pobierz statusy: client, server, baza
        try {
  ...
  return (
    <div className="sp-root">
        ...
        <div className="sp-window">
          ...
          <div className="sp-window-header">
            ...
            <div className="sp-header-right">
              <div className="sp-mini-health">
                <span className={`sp-mini-dot ${clientActive ? 'on' : 'off'}`} />
                <span className="sp-mini-label">Client</span>
                <span className="sp-mini-sep">|</span>
                <span className={`sp-mini-dot ${serverActive ? 'on' : 'off'}`} />
                <span className="sp-mini-label">Server</span>
                <span className="sp-mini-sep">|</span>
                <span className={`sp-mini-dot ${dbStatus ? 'on' : 'off'}`} />
                <span className="sp-mini-label">Baza</span>
              </div>
              {user && (
      ...
      <style jsx>{`
        ...
        .sp-mini-dot.on { background: #22c55e; }
        .sp-mini-dot.off { background: #ef4444; }
        .sp-mini-sep {
          opacity: 0.3;
          margin: 0 0.1rem;
        }
